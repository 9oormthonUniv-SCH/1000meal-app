...
- 회원 가입·관리 및 본인 확인
- 천원의 아침밥 서비스 제공(예약·QR 이용·공지 등)
- 고객 문의 및 불만 처리
- 서비스 개선 및 신규 서비스 개발

제2조 (수집하는 개인정보 항목)
① 필수 항목: 아이디, 비밀번호, 이름, 이메일 주소
② 서비스 이용 과정에서 자동 수집: 접속 로그, 접속 IP 정보, 서비스 이용 기록 등

제3조 (개인정보의 보유·이용 기간)
이용자의 개인정보는 원칙적으로 개인정보 수집 및 이용 목적이 달성된 후에는 지체 없이 파기합니다. 단, 관련 법령에 따라 보존할 필요가 있는 경우 해당 기간 동안 보관합니다.
